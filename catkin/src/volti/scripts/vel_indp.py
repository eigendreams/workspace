...
class Double_motor:
    ...
    def controller(self):
        ...
        #
        self.salida_m1              = self.pid_vel_m1.compute(self.vel_del_des - self.salida_control_angulo / self.vel_settings['ki_dec'], self.speed_m1, 0)
        self.salida_m2              = self.pid_vel_m2.compute(self.vel_del_des + self.salida_control_angulo / self.vel_settings['ki_dec'], self.speed_m2, 0)
        #
