...
class Double_motor:
    ...
    def __init__(self, node_name_default = 'double_motor_adjust'):
        ...
        self.profile_settings = {'max_output' : 20, 'max_speed' : 20, 'rate' : self.rate, 'heal_time_at_0pc' : 20, 'stable_point_pc' : 20}
        #
    ...
    def controller(self):
        ...
        self.ang_lat_diff               = self.rollPlate - self.rollPendu - 0.226 # pero este valor no debe salir de rango de entre -0.5 a 0.5, aprox
        #
        #
