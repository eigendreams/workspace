...
class Single_motor:
    ...
    def update(self):
        ...
        self.limited_out_m1 = constrain(self.out_pos_m1 + 50, -500, 500)#self.limit_m1.compute(self.final_out_m1)
        ...
        self.limited_out_m2 = constrain(self.out_pos_m2 + 50, -500, 500)#self.limit_m1.compute(self.final_out_m1)
