...
{
  Gyro_Vector[0]=1.2 * GYRO_SCALED_RAD(gyro[0]); //gyro x roll
  Gyro_Vector[1]=1.2 * GYRO_SCALED_RAD(gyro[1]); //gyro y pitch
  Gyro_Vector[2]=1.2 * GYRO_SCALED_RAD(gyro[2]); //gyro z yaw
