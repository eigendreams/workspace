...
class Tif2jpg:
    ...
    def __init__(self, node_name_override = 'tif2jpg'):
        ...
        rospy.loginfo("tif2jpg starting with name %s", self.nodename) 
        ...
        self.rate = rospy.get_param("tif2jpg_monitor_rate", 1)
    ...
    def update(self):
        ...
        subprocess.call(["convert", "/home/jakob/workspace/catkin/src/finder/maps/hector_slam_map.tif", "/home/jakob/workspace/interfaz_web/app/images/map.jpg"])
