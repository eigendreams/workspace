  ...
  class RosGstCapture
  {
    public: 
      RosGstCapture()
      {
        ...
        ros::param::param<std::string>("~device", device, "hw:1,0");
        ...
        // ros::param::param<std::string>("~src", source_type,"pulsesrc");
        ...
        _source = gst_element_factory_make(source_type.c_str(), NULL);
        ...
        // g_object_set(G_OBJECT(_source), "device", "plughw:2,0", NULL);

        // g_object_set(G_OBJECT(_encode), "channels", "4", NULL);
