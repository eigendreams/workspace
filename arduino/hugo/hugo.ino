...
void motor1_h(const std_msgs::Int16& d_msg) {	
  motor1des = d_msg.data;	
  timedOut = false;	
  timeLastMsg = millis();	
}
void motor2_h(const std_msgs::Int16& d_msg) {	
  motor2des = d_msg.data;	
  timedOut = false;	
  timeLastMsg = millis();	
}
void servo1_h(const std_msgs::Int16& d_msg) {	
  servo1des = d_msg.data;	
  timedOut = false;	
  timeLastMsg = millis();	
}
